...
const ProductId = ({ params }: ProductDetailsType) => {
  ...
  const currentProduct = cart.find((item: any) => item.id === product?.id);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3 p-3">
              ...
              <p className="text-gray-600 dark:text-gray-200">{product.review}</p>
              ...
              <p className="text-gray-500 dark:text-gray-200">
                Enjoy the freshness of our {product.title}. perfect on your
                dayly meals _ full and flavor and helth benifit.
              </p>
              ...
              <div>
                    ...
                    <button
                      ...
                      className={`border rounded-md border-gray-300 p-2 my-1 ${
                        active.toString() === size
                          ...
                          : "hover:bg-yellow-500 hover:text-white dark:text-gray-200"
                      }`}
                    >
                      {size}
                    </button>
                ...
                {/* counter app down  */}
                <div>
                  <h1 className="text-xl mt-3 text-gray-500 dark:text-gray-200">Quentity:</h1>
                  <button
                    onClick={() => handelIncrement(product.id)}
                    className="text-2xl border w-12 h-12 rounded-full border-gray-500 gap-10 cursor-pointer hover:bg-yellow-500 hover:text-white dark:text-gray-200"
                  >
                    +
                  </button>
                ...
                <div className="flex gap-10 mt-3">
                  <button className="bg-yellow-500 text-white font-semibold py-2 px-4 rounded-lg">
                    <Link onClick={() => handelCart(product)} href={""}>
                      Add to Cart
                    </Link>
                  </button>
