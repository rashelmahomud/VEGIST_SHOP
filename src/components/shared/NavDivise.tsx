...
const NavDivise = () => {
  ...
  return (
    <div className="lg:flex justify-between items-center lg:px-36 px-3">
      <ul className="grid lg:grid-cols-6 lg:gap-5 gap-2 divide-x-1 divide-gray-300 text-gray-500 dark:text-gray-200">
        <li className="group  flex gap-1 hover:text-yellow-500 duration-200 relative duration-300 font-semibold">
          <Link href={"/"} className="">
            Home
          </Link>
          <FontAwesomeIcon
        ...
        <li className="group flex gap-1 hover:text-yellow-500 duration-200 font-semibold relative duration-300">
        ...
        <li className="hover:text-yellow-500 duration-200 font-semibold">
        ...
        <li className="hover:text-yellow-500 duration-200 font-semibold relative">
      ...
      <div className="lg:flex jusity-center items-center lg:mr-18 gap-5 lg:block hidden">
        <Link href={"/"}>
          <FontAwesomeIcon
            icon={faHeadphones}
            className="text-3xl text-gray-500 dark:text-gray-200 hover:text-yellow-500"
          />
        </Link>
        <div>
          <h1 className="ml-2 font-semibold text-gray-500 dark:text-gray-200">Hotline:</h1>
          <Link href={"/"}>
            <span className="font-semibold hover:text-yellow-500 duration-300 text-gray-500 dark:text-gray-200">
              +8801835199061
            </span>
          </Link>
        </div>
